...
export default {
    ...
    <div class="compose-container mb-5 flex column  align-center"><span class="title-compose">Compos</span><img class="compos-icon ml-5" src="../../../../assets/imgs/compose.png"></div>
